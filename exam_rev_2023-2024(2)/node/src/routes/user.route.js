...
router.post('/favoritos/agregar', userController.agregarFavorito);

router.delete('/favoritos/:id', userController.eliminarFavorito);

router.get('/favoritos/:id', userController.getFavoritos);

router.get('/chat', userController.getChat);

router.post('/chat', userController.saveMessage);
